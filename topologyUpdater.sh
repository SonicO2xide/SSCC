...
CNODE_HOSTNAME="138.197.136.123"  # optional. must resolve to the IP you are requesting from
CNODE_BIN="~/.local/bin"
CNODE_HOME=/home/cardano/cardano-my-node
